...
namespace NShader
{
    public class NShaderColorableItem : ColorableItem
    {
        ...
        public NShaderColorableItem(string name, COLORINDEX foreColor, COLORINDEX backColor, Color hiForeColor, Color hiBackColor)
            : base(name, name, foreColor, backColor, hiForeColor, hiBackColor, FONTFLAGS.FF_DEFAULT)
        {
        }
