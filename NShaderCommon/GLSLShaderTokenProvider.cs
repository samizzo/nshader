...
namespace NShader
{
    public class GLSLShaderTokenProvider : IShaderTokenProvider
    {
        ...
        static GLSLShaderTokenProvider()
        {
            ...
            AddToDictionary("textureSize", ShaderToken.INTRINSIC);
            AddToDictionary("texture", ShaderToken.INTRINSIC);
            AddToDictionary("textureProj", ShaderToken.INTRINSIC);
            AddToDictionary("textureLod", ShaderToken.INTRINSIC);
            AddToDictionary("textureOffset", ShaderToken.INTRINSIC);
            AddToDictionary("texelFetch", ShaderToken.INTRINSIC);
            AddToDictionary("texelFetchOffset", ShaderToken.INTRINSIC);
            AddToDictionary("textureProjOffset", ShaderToken.INTRINSIC);
            AddToDictionary("textureLodOffset", ShaderToken.INTRINSIC);
            AddToDictionary("textureProjLod", ShaderToken.INTRINSIC);
            AddToDictionary("textureProjLodOffset", ShaderToken.INTRINSIC);
            AddToDictionary("textureGrad", ShaderToken.INTRINSIC);
            AddToDictionary("textureGradOffset", ShaderToken.INTRINSIC);
            AddToDictionary("textureProjGrad", ShaderToken.INTRINSIC);
            AddToDictionary("textureProjGradOffset", ShaderToken.INTRINSIC);
