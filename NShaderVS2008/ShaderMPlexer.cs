...
#region ScannerTables
    ...
    static int[] startState = {60, 55, 0};

   static int[] anchorState = {61, 55, 0};
...
/* p      */ 6, 6, 6, 6, 6, 6, 6, 6, 9, 6, 6, 28, 23, 29 };
    ...
    NxS[12] = // Shortest string """
        new Table(17, 2, 62, new sbyte[] {37, 63});
    ...
    NxS[38] = // Shortest string ".1"
        new Table(7, 10, -1, new sbyte[] {38, 38, -1, -1, 64, -1, 
        -1, -1, 39, 39});
    ...
    NxS[43] = // Shortest string "0."
        new Table(7, 10, -1, new sbyte[] {38, 38, -1, -1, 68, -1, 
        -1, -1, 44, 44});
    ...
    NxS[55] = // Shortest string ""
        new Table(0, 4, 57, new sbyte[] {56, 57, 57, 58});
    NxS[56] = // Shortest string ""
        new Table(0, 0, -1, null);
    NxS[57] = // Shortest string "/"
        new Table(0, 4, 57, new sbyte[] {-1, 57, 57, 58});
    NxS[58] = // Shortest string "*"
        new Table(1, 3, -1, new sbyte[] {59, -1, 58});
    ...
    NxS[63] = // Shortest string ""\"
        new Table(0, 1, 62, new sbyte[] {-1});
    NxS[64] = // Shortest string ".1E"
        new Table(7, 7, -1, new sbyte[] {40, 40, -1, -1, -1, 65, 
        65});
    ...
    NxS[66] = // Shortest string "0x"
        new Table(7, 10, -1, new sbyte[] {47, 47, -1, 47, 47, -1, 
        -1, -1, -1, 47});
    NxS[67] = // Shortest string "0E"
        new Table(7, 7, -1, new sbyte[] {46, 46, -1, -1, -1, 70, 
        70});
    NxS[68] = // Shortest string "0.E"
        new Table(7, 7, -1, new sbyte[] {45, 45, -1, -1, -1, 69, 
        69});
    NxS[69] = // Shortest string "0.E+"
        new Table(7, 2, -1, new sbyte[] {45, 45});
    NxS[70] = // Shortest string "0E+"
        new Table(7, 2, -1, new sbyte[] {46, 46});
